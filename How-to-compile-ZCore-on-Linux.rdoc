...
== Disable-wallet mode
When the intention is to run only a P2P node without a wallet, ZCore may be compiled in
disable-wallet mode with:
```
    ./configure --disable-wallet
```
P.S: In this case there is no dependency on Berkeley DB 4.8.
